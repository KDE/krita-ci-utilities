...
import subprocess
import sys
from components import MergeFolders, CommonUtils
...
useVerbosePackagingLog = CommonUtils.useVerbosePackagingLog()
...
if not CommonUtils.boolFromEnv(os.environ.get('KRITACI_SKIP_DEBUG_PACKAGE', '0')):
    logger.info("")
