...
def generateFor( installPrefix ):
    ...
    # Make sure that is included too
        ...
        envChanges = changesForPrefix( "/usr/local/llvm13", envChanges )
...
def changesForPrefix( installPrefix, envChanges, systemPrefix=False ):
    ...
    libDirSuffixes = ['lib', 'lib32', 'lib64', 'lib/x86_64-linux-gnu', 'libdata']
    if sys.platform == 'win32':
        libDirSuffixes.append('lib/qt6')
    for libraryDirName in libDirSuffixes:
        # Do LD_LIBRARY_PATH
